...
const server = http.createServer((req,res) => {
    ...
    //http://127.0.0.1:1337/laptops?id=5
    console.log(pathName);//  returns: /laptops
    console.log(query);   // returns: { id: '5' }
    // url: http://127.0.0.1:1337/laptops?id=4&name=apple&date=today
    // return: [Object: null prototype] { id: '4', name: 'apple', date: 'today' }
    ...
    if (pathName === '/products' || pathName==='/'){
        ...
        fs.readFile(`${__dirname}/templates/template-overview.html`, 'utf-8', (err, data) => {
            ...
            fs.readFile(`${__dirname}/templates/template-card.html`, 'utf-8', (err2, data2) => {
                const cardsOutput = laptopData.map( e => replaceTemplate(data2,e)).join('');
